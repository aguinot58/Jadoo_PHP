                ...
                if ($_SESSION['logged'] == 'oui') {
                    ...
                    echo '<div class="container pt-5">
                        <div class="col mt-5 mx-auto">
                            <a class="text-decoration-none text-dark" href="./../pages/back_plat.php">
                                <div class="card shadow p-3 mb-5 bg-white rounded w-75 mx-auto">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                        <img class="bd-placeholder-img img-fluid" src="./../img/plats.png" width="100%" height="250" role="img" aria-label="Placeholder: Image" preserveAspectRatio="xMidYMid slice" focusable="false"></img>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <h5 class="card-title">Plats</h5>
                                                <p class="card-text">Ici vous pouvez ajouter, modifier ou supprimer des plats.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <a class="text-decoration-none text-dark" href="./../pages/back_cat.php">
                                <div class="card shadow p-3 mb-5 bg-white rounded w-75 mx-auto">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img class="bd-placeholder-img img-fluid" src="./../img/categories.png" width="100%" height="250" role="img" aria-label="Placeholder: Image" preserveAspectRatio="xMidYMid slice" focusable="false"></img>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <h5 class="card-title">Catégories de plats</h5>
                                                <p class="card-text">Ici vous pouvez consulter, ajouter, modifier ou supprimer les différentes catégories de plats.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    echo '<div class="wrapper fadeInDown mt-5">
                            ...
                            <div class="fadeIn first mt-3">
                                <img src="./../img/favicon.ico" id="icon" alt="Icone Jadoo" />
                            </div>
