            ...
            <?php 
                ...
                if ($_SESSION['logged'] == 'oui' && $_SESSION['admin'] = 'oui') {
                    ...
                    echo '<div class="container mb-5 table-responsive">
                            <h3 class="mb-4">Liste des messages</h3>';
                    ...
                    require $lien.'pages/conn_bdd.php';
                        ...
                        try{
                            ...
                            foreach ($messages as $message) {
                                ...
                                echo '<tr>
                                        <th class="align-middle text-center" scope="row">'.$message['Id'].'</th>
                                        <td class="align-middle text-center">'.$message['Date_msg'].'</td>
                                        <td class="align-middle text-center">'.$message['Nom'].'</td>
                                        <td class="align-middle text-center">'.$message['Prenom'].'</td>
                                        <td class="align-middle text-center">'.$message['Email'].'</td>
                                        <td class="align-middle text-center">'.$message['Message'].'</td>
                                        <td class="align-middle text-center">
                                            <div class="d-flex flex-row">
                                                <div>
                                                    <button type="button" class="btn open_modal" data-id="'.$message['Id'].'" name="mod_'.$message['Id'].'">
                                                        <i name="mod_'.$message['Id'].'" class="fas fa-eye" data-id="'.$message['Id'].'" id="mod_'.$message['Id'].'"></i>
                                                    </button>
                                                </div>
                                                <div >
                                                    <button type="button" class="btn" onclick="Suppr_msg(event)" name="del_'.$message['Id'].'">
                                                        <i name="del_'.$message['Id'].'" class="fas fa-trash-can" id="del_'.$message['Id'].'"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        </td>';
